 ...
 */
public class tagEdsDirectoryItemInfo extends Structure {
	/** C type : EdsUInt32 */
	...
	public tagEdsDirectoryItemInfo() {
		super();
	}
	 ...
	 */
	public tagEdsDirectoryItemInfo(NativeLong size, int isFolder, NativeLong groupID, NativeLong option, byte szFileName[], NativeLong format, NativeLong dateTime) {
		super();
		this.size = size;
	...
	public tagEdsDirectoryItemInfo(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagEdsDirectoryItemInfo implements Structure.ByReference {
		
	};
	public static class ByValue extends tagEdsDirectoryItemInfo implements Structure.ByValue {
