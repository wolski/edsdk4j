 ...
 */
public class tagEdsUsersetData extends Structure {
	/** C type : EdsUInt32 */
	 ...
	 */
	public tagEdsUsersetData(NativeLong valid, NativeLong dataSize, byte szCaption[], byte data[]) {
		super();
		this.valid = valid;
	...
	public tagEdsUsersetData(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagEdsUsersetData implements Structure.ByReference {
		
	};
	public static class ByValue extends tagEdsUsersetData implements Structure.ByValue {
